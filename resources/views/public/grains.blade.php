...
<body class="bg-earth-50 font-sans">
    ...
    <aside class="fixed left-0 top-0 w-72 h-screen bg-gradient-to-br from-earth-500 to-earth-400 shadow-2xl z-50 overflow-y-auto">
        ...
        <nav class="p-5">
            <div class="mb-8">
                ...
                <a href="{{route('category', ['category' => 'grains'])}}" class="flex items-center gap-3 px-4 py-3 text-white bg-white/15 rounded-xl mb-2 hover:bg-white/20 transition-all duration-300 hover:translate-x-1">
                    <span class="text-xl">🌾</span>
    ...
    <main class="ml-72 p-10">
        ...
        <section class="mb-16">
            <div class="space-y-6">
                <h1 class="font-serif">
                    <span class="block text-6xl font-bold text-earth-500 mb-2">🌾 Grains</span>
                    <span class="block text-3xl text-earth-300">Certified Organic Seeds</span>
                </h1>
                <p class="text-lg text-gray-600 leading-relaxed max-w-2xl">
                    Certified organic grains for sustainable agriculture. Heirloom and resistant varieties.
                </p>
                <div class="inline-flex items-center gap-3 bg-white rounded-2xl shadow-sm px-6 py-4">
                    <span class="text-3xl font-serif font-bold text-earth-400">{{ $products->count() }}</span>
        ...
        <!-- <section class="mb-10">
            <div class="bg-white rounded-2xl shadow-sm p-6 flex flex-wrap gap-5 items-center">
                <div class="flex-1 min-w-[300px] flex gap-2 bg-earth-50 rounded-xl p-1">
                    <input type="text" placeholder="Search in grains..." id="searchInput" class="flex-1 px-4 py-3 bg-transparent border-none outline-none text-gray-700">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8" id="productsGrid">
                ...
                @empty
                    <div class="col-span-full text-center py-20">
                        ...
                        <h3 class="text-2xl font-serif font-semibold text-earth-500 mb-2">No grains available</h3>
                        <p class="text-gray-500">Check back soon for new grains</p>
                    </div>
                @endforelse
            </div>
        </section>
