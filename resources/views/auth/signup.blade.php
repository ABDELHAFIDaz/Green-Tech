...
<body class="bg-gradient-to-br from-earth-50 via-white to-earth-100 min-h-screen font-sans flex items-center justify-center p-4">
    ...
    <div class="w-full max-w-md">
        ...
        <div class="text-center mb-8">
            ...
            <p class="text-gray-600 mt-2">Join us for sustainable agriculture</p>
        </div>

        <!-- Signup Card -->
        <div class="bg-white rounded-3xl shadow-2xl p-8 backdrop-blur-lg border border-earth-100">
            <h2 class="font-serif text-3xl font-bold text-earth-500 mb-2">Create Account</h2>
            <p class="text-gray-600 mb-8">Get started with your free account</p>
            ...
            <form action="{{ route('register') }}" method="POST" class="space-y-6">
                ...
                <!-- Name -->
                <div>
                    <label for="name" class="block text-sm font-semibold text-earth-500 mb-2">Full Name</label>
                    <input 
                        type="text" 
                        id="name" 
                        name="name" 
                ...
                <!-- Password -->
                <div>
                    <label for="password" class="block text-sm font-semibold text-earth-500 mb-2">Password</label>
                    <input 
                        type="password" 
                        id="password" 
                        name="password" 
                ...
                <!-- Confirm Password -->
                <div>
                    <label for="password_confirmation" class="block text-sm font-semibold text-earth-500 mb-2">Confirm Password</label>
                    <input 
                        type="password" 
            ...
            <p class="mt-8 text-center text-sm text-gray-600">
                ...
                <a href="{{ route('login.page') }}" class="text-earth-400 hover:text-earth-500 font-semibold">Login here</a>
            </p>
        </div>
